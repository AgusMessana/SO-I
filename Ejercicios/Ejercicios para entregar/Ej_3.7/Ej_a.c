...
/**
 * El programa ingenuo puede terminar en deadlock por espera circular.
 * Si el agente saca el caso = 0, pone en la mesa papel y tabaco.
 * El fumador 3 se despierta, toma el papel y se bloquea esperando los fósforos.
 * Luego, el fumador 1 toma el tabaco y se bloquea esperando el papel (que ya tiene el fumador 3).
 * Ninguno logra su combo completo, nadie le avisa al agente y el sistema se congela para siempre.
 */
