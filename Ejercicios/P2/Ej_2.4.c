 ...
 * Aunque volatile le indica al compilador que no optimice el
 acceso a las variables x e y, no se garantiza la atomicidad ni
 orden de escritura. Podría pasar que wr escriba x = 123 e y = 1
 pero el procesador podría reordenar las escrituras, provocando
 un assert(0).
